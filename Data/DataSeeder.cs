        ...
        public static async Task SeedCompaniesAsync(ApplicationDbContext context)
{
    if (!context.Companies.Any())
    {
        context.Companies.AddRange(
            new Company { Id = 1, Name = "Google", Industry = "Technology", Location = "Mountain View, CA", Website = "https://www.google.com" },
            new Company { Id = 2, Name = "Microsoft", Industry = "Technology", Location = "Redmond, WA", Website = "https://www.microsoft.com" },
            new Company { Id = 3, Name = "Amazon", Industry = "E-commerce", Location = "Seattle, WA", Website = "https://www.amazon.com" },
            new Company { Id = 4, Name = "Tesla", Industry = "Automotive", Location = "Austin, TX", Website = "https://www.tesla.com" },
            new Company { Id = 5, Name = "Meta", Industry = "Social Media", Location = "Menlo Park, CA", Website = "https://www.meta.com" }
        );
        await context.SaveChangesAsync();
    }
}
